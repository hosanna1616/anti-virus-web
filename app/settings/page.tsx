        ...
        <div className="container px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="text-center space-y-4 animate-fade-in-up">
              ...
              <p className="text-muted-foreground">Customize your EthioShield experience</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 stagger-children">
              ...
              <Card className="hover-lift bg-card/80 backdrop-blur">
                <CardHeader>
                  ...
                  <CardDescription>Configure your protection preferences</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => updateSetting("realTimeProtection", checked)}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => updateSetting("firewallProtection", checked)}
                    />
                  </div>
                  <div className="space-y-2">
                    <Label>Scan Sensitivity: {settings.scanSensitivity[0]}%</Label>
                    <Slider
                      value={settings.scanSensitivity}
                      onValueChange={(value) => updateSetting("scanSensitivity", value)}
                      max={100}
                      step={1}
                    />
                  </div>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => updateSetting("scanComplete", checked)}
                    />
                  </div>
                  <div className="flex items-center justify-between">
